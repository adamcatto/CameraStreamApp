...
AWB red/blue gains, brightness, contrast, saturation, sharpness, EV, and frame
rate). The AWB gains default to 0, which keeps automatic white balance; setting
both switches that camera to manual white balance. Because the Pi
