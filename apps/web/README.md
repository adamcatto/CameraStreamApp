...
shutter, gain, AWB red/blue gains, brightness, contrast, saturation, sharpness,
EV compensation, and frame rate. The AWB gains default to 0 (automatic white
balance); setting both switches the camera to manual white balance. The
Raspberry Pi camera stack accepts these only as launch
