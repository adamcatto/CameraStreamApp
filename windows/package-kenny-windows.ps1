...
Provide paths:
  .\package-kenny-windows.ps1 [workspaces.json] [credentials.json]
...
Add passwords, then run .\package-kenny-windows.ps1 again.
"@
}
...
function Build() {
    $bundleFile = Join-Path $env:TEMP "kenny-credentials.bundle.json"
...
Write-Host "Share this zip privately - it contains lab IPs and passwords."
